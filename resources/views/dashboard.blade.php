    ...
    <div class="flex">
        <div class="md:flex w-2/5 md:w-1/4 h-screen bg-white border-r hidden">
            <div class="mx-auto py-10">
                <h1 class="text-2xl font-bold mb-10 cursor-pointer text-[#EC5252] duration-150">TutorFinder</h1>
                <ul>
                    ...
                    <li class="flex space-x-2 mt-10 cursor-pointer hover:text-[#EC5252] duration-150">
                        ...
                        <a href="/tutors" ><span class="font-semibold">All Tutors</span></a>
                    </li>
                    <a href="/booked/tutors/{{Auth::id()}}">
                    <li class="flex space-x-2 mt-10 cursor-pointer hover:text-[#EC5252] duration-150">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor">
                        ...
                        <span class="font-semibold">My Booked Tutors</span>
                    </li>
                    </a>
                    <li class="flex space-x-2 mt-10 cursor-pointer hover:text-[#EC5252] duration-150">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
...
{{--                </div>--}}
    ...
    <footer class="text-center py-6 bg-gray-100">
        Copyright &copy; 2022 majid.com all rights reserved
    </footer>
    </main>
    </div>
</x-app-layout>
